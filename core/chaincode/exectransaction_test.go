...
func TestExecuteDeployTransaction(t *testing.T) {
	...
	executeDeployTransaction(t, chainID, "example01", "justledger/examples/chaincode/go/chaincode_example01")
}
...
func TestExecuteInvokeInvalidTransaction(t *testing.T) {
	...
	url := "justledger/examples/chaincode/go/chaincode_example02"
...
func TestChaincodeQueryChaincodeUsingInvoke(t *testing.T) {
	...
	// Deploy first chaincode
	url1 := "justledger/examples/chaincode/go/chaincode_example02"
	...
	// Deploy second chaincode
	url2 := "justledger/examples/chaincode/go/chaincode_example05"
...
func TestChaincodeInvokesForbiddenSystemChaincode(t *testing.T) {
	...
	// Deploy second chaincode
	url := "justledger/examples/chaincode/go/passthru"
