...
import (
	...
	"justledger/integration/pvtdata/helpers"
	"justledger/integration/pvtdata/runner"
	"justledger/integration/pvtdata/world"
...
var _ = Describe("PrivateData-EndToEnd", func() {
	...
	PDescribe("collection config is modified", func() {
		BeforeEach(func() {
			...
			installChaincodeOnAllPeers(1, 3, d.Chaincode.Name, "2.0", "justledger/integration/chaincode/marbles_private/cmd", testDir)
		})
		...
		It("verifies access to private data after an org is removed from collection config and then added back", func() {
			...
			installChaincodeOnAllPeers(1, 3, d.Chaincode.Name, "3.0",
				"justledger/integration/chaincode/marbles_private/cmd", testDir)
	...
	PDescribe("collection config BlockToLive is respected", func() {
		...
		It("verifies private data is purged after BTL has passed and new peer doesn't pull private data that was purged", func() {
			...
			adminPeer.InstallChaincode("marblesp", "1.0", "justledger/integration/chaincode/marbles_private/cmd")
	...
	PDescribe("network partition with respect of private data", func() {
		BeforeEach(func() {
			...
			installChaincodeOnAllPeers(1, 2, d.Chaincode.Name, "2.0", "justledger/integration/chaincode/marbles_private/cmd", testDir)
		})
		...
		It("verifies private data not distributed when there is network partition", func() {
			...
			adminPeer.InstallChaincode("marblesp", "2.0", "justledger/integration/chaincode/marbles_private/cmd")
