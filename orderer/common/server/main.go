...
import (
	...
	"github.com/justledger/fabric/orderer/common/bootstrap/file"
	"github.com/justledger/fabric/orderer/common/cluster"
	"github.com/justledger/fabric/orderer/common/localconfig"
	"github.com/justledger/fabric/orderer/common/metadata"
	...
	"github.com/justledger/fabric/orderer/consensus/kafka"
	"github.com/justledger/fabric/orderer/consensus/solo"
...
// command line flags
var (
	app = kingpin.New("orderer", "justledger Fabric orderer node")
